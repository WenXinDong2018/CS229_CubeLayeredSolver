...
python ctg_approx/avi_multihead.py --env cube3 --states_per_update 500000 --batch_size 4 --nnet_name final_cube3multihead_transformer_8 --max_itrs 46200 --loss_thresh 0.2 --back_max 30 --num_update_procs 30
