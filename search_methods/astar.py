...
def bwas_cpp(args, env: Environment, states: List[State], results_file: str):
    assert (args.env.upper() in ['CUBE3', 'CUBE3LAYER1','CUBE3LAYER2', 'CUBE3LAYER3', 'CUBE4', 'PUZZLE15', 'PUZZLE24', 'PUZZLE35', 'PUZZLE48', 'LIGHTSOUT7'])
    ...
    # Get state dimension
    if args.env.upper() == "CUBE3" or args.env.upper() == "CUBE3LAYER1" or args.env.upper() == "CUBE3LAYER2" or args.env.upper() == "CUBE3LAYER3":
        state_dim: int = 54
